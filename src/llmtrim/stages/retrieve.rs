...
/// CELF greedy in [`crate::llmtrim::select`]). Two near-duplicate chunks that top-k would both
...
///   budget: `ratio · Σ chunk tokens`. Coverage in [`crate::llmtrim::select`] then drops the chunks
