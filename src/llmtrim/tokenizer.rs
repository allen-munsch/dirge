...
/// result types ([`crate::llmtrim::CompressResult`], [`crate::llmtrim::pipeline::PipelineOutcome`],
/// [`crate::llmtrim::pipeline::StageReport`]); transient local arithmetic stays plain `usize`,
